"use strict";
(self["webpackChunkpjcan"] = self["webpackChunkpjcan"] || []).push([[641],{

/***/ 61346:
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $9: function() { return /* binding */ VirtualRenderingStrategy; },
/* harmony export */   Ay: function() { return /* binding */ Flicking; },
/* harmony export */   JO: function() { return /* binding */ getDefaultCameraTransform; },
/* harmony export */   OH: function() { return /* binding */ sync; },
/* harmony export */   U2: function() { return /* binding */ getFlickingAttached; },
/* harmony export */   Z5: function() { return /* binding */ NormalRenderingStrategy; },
/* harmony export */   ko: function() { return /* binding */ getRenderingPanels; },
/* harmony export */   qD: function() { return /* binding */ withFlickingMethods; },
/* harmony export */   qY: function() { return /* binding */ EVENTS; },
/* harmony export */   y1: function() { return /* binding */ range; },
/* harmony export */   zZ: function() { return /* binding */ ExternalRenderer; }
/* harmony export */ });
/* unused harmony exports ALIGN, AnchorPoint, AnimatingState, AxesController, BoundCameraMode, CIRCULAR_FALLBACK, CLASS, Camera, CircularCameraMode, Control, DIRECTION, DisabledState, DraggingState, ERROR_CODE, FlickingError, FreeControl, HoldingState, IdleState, LinearCameraMode, MOVE_TYPE, ORDER, Panel, Renderer, SnapControl, State, StateMachine, StrictControl, VanillaElementProvider, VanillaRenderer, Viewport, VirtualElementProvider, VirtualManager, VirtualPanel, checkExistence, circulateIndex, circulatePosition, clamp, find, findIndex, findRight, getDirection, getElement, getElementSize, getMinusCompensatedIndex, getProgress, getStyle, includes, isBetween, isString, merge, parseAlign, parseArithmeticExpression, parseArithmeticSize, parseBounce, parseCSSSizeValue, parseElement, parsePanelAlign, setPrototypeOf, setSize, toArray */
...
/* harmony import */ var _egjs_axes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16054);
/* harmony import */ var _egjs_imready__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36700);
...
var State = /*#__PURE__*/function () {
  ...
  __proto._moveToChangedPosition = function (ctx) {
    ...
    var moveEvent = new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.MOVE, {
...
var IdleState = /*#__PURE__*/function (_super) {
  ...
  __proto.onHold = function (ctx) {
    ...
    var holdStartEvent = new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.HOLD_START, {
      axesEvent: axesEvent
    });
  ...
  __proto.onChange = function (ctx) {
    ...
    var moveStartEvent = new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.MOVE_START, {
      isTrusted: axesEvent.isTrusted,
      holding: this.holding,
...
var HoldingState = /*#__PURE__*/function (_super) {
  ...
  __proto.onRelease = function (ctx) {
    var flicking = ctx.flicking,
      axesEvent = ctx.axesEvent,
      transitTo = ctx.transitTo;
    flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.HOLD_END, {
      axesEvent: axesEvent
    }));
  ...
  __proto.onFinish = function (ctx) {
    ...
    if (clickedPanel) {
      ...
      flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.SELECT, {
...
var AnimatingState = /*#__PURE__*/function (_super) {
  ...
  __proto.onFinish = function (ctx) {
    ...
    var animatingContext = controller.animatingContext;
    transitTo(STATE_TYPE.IDLE);
    flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.MOVE_END, {
      isTrusted: axesEvent.isTrusted,
      direction: getDirection(animatingContext.start, animatingContext.end),
      axesEvent: axesEvent
    }));
...
var AxesController = /*#__PURE__*/function () {
  ...
  __proto.init = function (flicking) {
    ...
    var _this = this;
    this._flicking = flicking;
    this._axes = new _egjs_axes__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Ay((_a = {}, _a[POSITION_KEY] = {
      range: [0, 0],
      circular: false,
      bounce: [0, 0]
    }, _a), {
    ...
    this._panInput = new _egjs_axes__WEBPACK_IMPORTED_MODULE_2__/* .PanInput */ .YT(flicking.viewport.element, {
...
var Control = /*#__PURE__*/function () {
  ...
  __proto.setActive = function (newActivePanel, prevActivePanel, isTrusted) {
    ...
    if (newActivePanel !== prevActivePanel) {
      flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.CHANGED, {
      ...
      flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.RESTORED, {
        isTrusted: isTrusted
      }));
    }
  };
  ...
  __proto._triggerIndexChangeEvent = function (panel, position, axesEvent, direction) {
    ...
    var camera = flicking.camera;
    var activePanel = this._activePanel;
    var event = new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(triggeringEvent, {
      index: panel.index,
      panel: panel,
...
var Camera = /*#__PURE__*/function () {
  ...
  __proto._refreshVisiblePanels = function () {
    ...
    if (added.length > 0 || removed.length > 0) {
      void flicking.renderer.render().then(function () {
        flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.VISIBLE_CHANGE, {
          added: added,
          removed: removed,
  ...
  __proto._checkNeedPanel = function () {
    ...
    if (panels.length <= 0) {
      if (!needPanelTriggered.prev) {
        flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.NEED_PANEL, {
  ...
  __proto._checkReachEnd = function (prevPos, newPos) {
    ...
    flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.REACH_EDGE, {
      direction: direction
    }));
  };
...
var Renderer = /*#__PURE__*/function () {
  ...
  __proto.updateAfterPanelChange = function (panelsAdded, panelsRemoved) {
    ...
    if (panelsAdded.length > 0 || panelsRemoved.length > 0) {
      flicking.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.PANEL_CHANGE, {
        added: panelsAdded,
  ...
  __proto.checkPanelContentsReady = function (checkingPanels) {
    ...
    var contentsReadyChecker = new _egjs_imready__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Ay();
...
var Flicking = /*#__PURE__*/function (_super) {
  ...
  __proto.init = function () {
    ...
    return renderer.render().then(function () {
      ...
      _this.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.READY));
    });
  };
  /**
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            this.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.BEFORE_RESIZE, {
              width: prevWidth,
              height: prevHeight,
          ...
          case 2:
            ...
            this.trigger(new _egjs_component__WEBPACK_IMPORTED_MODULE_1__/* .ComponentEvent */ .O(EVENTS.AFTER_RESIZE, {
...
var withFlickingMethods = function (prototype, flickingName) {
  [_egjs_component__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.prototype, Flicking.prototype].forEach(function (proto) {
